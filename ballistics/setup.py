...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Ballistics.py"
 
        #Name of program
        self.project_name = "Ballistics"
        ...
        #Auhor of program
        self.author_name = "Rafi Khan"
        self.author_email = "zetoslab@gmail.com"
        self.copyright = "Copyright (c) 2016 Rafi Khan."
 
        #Description
        self.project_description = "Ballistics Game"
